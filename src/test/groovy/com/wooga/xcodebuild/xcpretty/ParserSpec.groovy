...
import static com.wooga.xcodebuild.XcodeFixtures.*
...
class ParserSpec extends Specification {
    ...
    def "parses restarting failing tests"() {
        when:
        SAMPLE_SWIFT_FATAL_ERROR_IN_TEST_MAKE_TESTS_RESTARTING.eachLine {
            parser.parse(it)
        }

        then:
        1 * formatter.formatFailingTest(
                "xcprettyFatalErrorTests.xcprettyFatalErrorTests",
                "testFatalError",
                "Test crashed",
                "n/a")
    }
