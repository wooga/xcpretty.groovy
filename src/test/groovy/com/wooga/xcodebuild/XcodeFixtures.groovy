...
package com.wooga.xcodebuild

class XcodeFixtures {
    static String KIWI = 'kiwi'
    static String OCUNIT = 'ocunit'
    static String SAMPLE_OCUNIT_TEST_RUN_BEGINNING = "Test Suite '/Users/musalj/Library/Developer/Xcode/DerivedData/ReactiveCocoa-eznxkbqvgfsnrvetemqloysuwagb/Build/Products/Test/ReactiveCocoaTests.octest(Tests)' started at 2013-12-10 07:04:33 +0000"
    static String SAMPLE_KIWI_TEST_RUN_BEGINNING = "Test Suite 'ObjectiveRecordTests.xctest' started at 2013-12-10 06:15:39 +0000"
    static String SAMPLE_SPECTA_TEST_RUN_BEGINNING = "    Test Suite 'KIFTests.xctest' started at 2014-02-28 15:43:42 +0000"
    static String SAMPLE_OCUNIT_TEST_RUN_COMPLETION = "Test Suite '/Users/musalj/Library/Developer/Xcode/DerivedData/ReactiveCocoa-eznxkbqvgfsnrvetemqloysuwagb/Build/Products/Test/ReactiveCocoaTests.octest(Tests)' finished at 2013-12-10 07:03:03 +0000."
    static String SAMPLE_OCUNIT_FAILED_TEST_RUN_COMPLETION = "Test Suite '/Users/dm/someplace/Macadamia.octest' failed at 2014-09-24 23:09:20 +0000."
    static String SAMPLE_OCUNIT_PASSED_TEST_RUN_COMPLETION = "Test Suite 'Hazelnuts.xctest' passed at 2014-09-24 23:09:20 +0000."
    static String SAMPLE_KIWI_TEST_RUN_COMPLETION = "Test Suite 'ObjectiveRecordTests.xctest' finished at 2013-12-10 06:15:42 +0000."
    static String SAMPLE_SPECTA_TEST_RUN_COMPLETION = "     Test Suite 'KIFTests.xctest' finished at 2014-02-28 15:44:32 +0000."

    static String SAMPLE_OCUNIT_SUITE_BEGINNING = "Test Suite 'RACKVOWrapperSpec' started at 2013-12-10 21:06:10 +0000"
    static String SAMPLE_SPECTA_SUITE_BEGINNING = "   Test Suite 'All tests' started at 2014-02-28 19:07:41 +0000"
    static String SAMPLE_KIWI_SUITE_COMPLETION = "Test Suite 'All tests' finished at 2013-12-08 04:26:49 +0000."
    static String SAMPLE_OCUNIT_SUITE_COMPLETION = "Test Suite '/Users/musalj/Library/Developer/Xcode/DerivedData/ReactiveCocoa-eznxkbqvgfsnrvetemqloysuwagb/Build/Products/Test/ReactiveCocoaTests.octest(Tests)' finished at 2013-12-08 22:09:37 +0000."
    static String SAMPLE_XCTEST_SUITE_COMPLETION = "Test Suite 'ObjectiveSugarTests.xctest' finished at 2013-12-09 04:42:13 +0000."

    static String SAMPLE_UITEST_CASE_WITH_FAILURE = '''
    ...
    static String SAMPLE_XCTEST_FAILURE = ""
    static String SAMPLE_KIWI_FAILURE = "/Users/musalj/code/OSS/ObjectiveSugar/Example/ObjectiveSugarTests/NSNumberTests.m:49: error: -[NumberAdditions Iterators_TimesIteratesTheExactNumberOfTimes] : 'Iterators, times： iterates the exact number of times' [FAILED], expected subject to equal 4, got 5"
    static String SAMPLE_OLD_SPECTA_FAILURE = "/Users/musalj/code/OSS/ReactiveCocoa/ReactiveCocoaFramework/ReactiveCocoaTests/RACCommandSpec.m:458: error: -[RACCommandSpec enabled_signal_should_send_YES_while_executing_is_YES_and_allowsConcurrentExecution_is_YES] : expected: 1, got: 0"
    static String SAMPLE_SPECTA_FAILURE = '''
    ...
    static String SAMPLE_SWIFT_FATAL_ERROR_IN_TEST_MAKE_TESTS_RESTARTING = '''
    ...
    static String SAMPLE_BUILD = "=== BUILD TARGET The Spacer OF PROJECT Pods WITH THE DEFAULT CONFIGURATION Debug ==="
    static String SAMPLE_ANALYZE_TARGET = "=== ANALYZE TARGET The Spacer OF PROJECT Pods WITH THE DEFAULT CONFIGURATION Debug ==="
    static String SAMPLE_AGGREGATE_TARGET = "=== BUILD AGGREGATE TARGET Be Aggro OF PROJECT AggregateExample WITH CONFIGURATION Debug ==="
    static String SAMPLE_CLEAN = "=== CLEAN TARGET Pods-ObjectiveSugar OF PROJECT Pods WITH CONFIGURATION Debug ==="
    static String SAMPLE_ANOTHER_CLEAN = "=== CLEAN TARGET Pods OF PROJECT Pods WITH CONFIGURATION Debug ==="
    static String SAMPLE_BUILD_SUCCEEDED = "** BUILD SUCCEEDED **"
    static String SAMPLE_CLEAN_SUCCEEDED = "** CLEAN SUCCEEDED **"
    static String SAMPLE_CLEAN_REMOVE = '''
                    ...
                    '''.stripIndent().trim()
    static String SAMPLE_EXECUTED_TESTS = "Executed 4 tests, with 0 failures (0 unexpected) in 0.003 (0.004) seconds"
    static String SAMPLE_SPECTA_EXECUTED_TESTS = "       Executed 4 tests, with 0 failures (0 unexpected) in 10.192 (10.193) seconds"
    static String SAMPLE_OCUNIT_TEST = "Test Case '-[RACCommandSpec enabled_signal_should_send_YES_while_executing_is_YES]' passed (0.001 seconds)."
    static String SAMPLE_SPECTA_TEST = "         Test Case '-[SKWelcomeActivationViewControllerSpecSpec SKWelcomeActivationViewController_When_a_user_enters_their_details_lets_them_enter_a_valid_manager_code]' passed (0.725 seconds)."
    static String SAMPLE_SLOWISH_TEST = "Test Case '-[RACCommandSpec enabled_signal_should_send_YES_while_executing_is_YES_and_allowsConcurrentExecution_is_YES]' passed (0.026 seconds)."
    static String SAMPLE_SLOW_TEST = "Test Case '-[RACCommandSpec enabled_signal_should_send_YES_while_executing_is_YES_and_allowsConcurrentExecution_is_YES]' passed (0.101 seconds)."
    static String SAMPLE_KIWI_TEST = "Test Case '-[MappingsTests Mappings_SupportsCreatingAParentObjectUsingJustIDFromTheServer]' passed (0.004 seconds)."
    static String SAMPLE_PENDING_KIWI_TEST = "Test Case '-[TAPIConversationSpec TAPIConversation_createConversation_SendsAPOSTRequestToTheConversationsEndpointPENDING]' passed (0.001 seconds)."
    static String SAMPLE_MEASURING_TEST = '''<unknown>:0: Test Case '-[SecEncodeTransformTests.SecEncodeTransformTests test_RFC4648_Decode_UsingBase32]' measured [Time, seconds] average: 0.013, relative standard deviation: 26.773%, values: [0.023838, 0.012034, 0.013512, 0.011022, 0.011203, 0.012814, 0.011131, 0.012740, 0.013646, 0.012145], performanceMetricID:com.apple.XCTPerformanceMetric_WallClockTime, baselineName: " ", baselineAverage: , maxPercentRegression: 10.000%, maxPercentRelativeStandardDeviation: 10.000%, maxRegression: 0.100, maxStandardDeviation: 0.100'''
    static String SAMPLE_COMPILE = '''
                    ...
                    '''.stripIndent().trim()
    static String SAMPLE_COMPILE_SPACE_IN_PATH = '''
    ...
    static String SAMPLE_ANOTHER_COMPILE = '''
                    ...
                    '''.stripIndent().trim()
    static String SAMPLE_COMPILE_CCACHE = '''
    ...
    static String SAMPLE_SWIFT_COMPILE = '''
    ...
    static String SAMPLE_PRECOMPILE = '''
    ...
    static String SAMPLE_LIBTOOL = '''
                    ...
                    '''.stripIndent().trim()
    static String SAMPLE_CPRESOURCE = '''
    ...
    static String SAMPLE_COPYSTRINGS = '''
    ...
    static String SAMPLE_PROCESS_INFOPLIST = '''
    ...
    static String SAMPLE_LD_RELATIVE = '''
    ...
    static String SAMPLE_WRITE_FILE = '''
    ...
    static String SAMPLE_WRITE_AUXILIARY_FILES = '''Write auxiliary files'''

    static String SAMPLE_TIFFUTIL = '''
    ...
    static String SAMPLE_RUN_SCRIPT = '''
    ...
    static String SAMPLE_ANALYZE_SHALLOW = '''
    ...
    static String SAMPLE_ANALYZE_CPP = '''
    ...
    static String SAMPLE_COMPILE_XIB = '''
    ...
    static String SAMPLE_COMPILE_STORYBOARD = '''
    ...
    static String SAMPLE_CODESIGN_FRAMEWORK = '''
    ...
    static String SAMPLE_PREPROCESS = '''
    ...
    static String SAMPLE_SCREENSHOT_FILE = 'RACCommandSpec_enabled_signal_should_send_YES_while_executing_is_YES.png'
    static String SAMPLE_UNRELATED_IMAGE_FILE = 'apple_raw.png'

    ////////////////////////////////////////////////////////////////////////////////////
    // ERRORS
    ////////////////////////////////////////////////////////////////////////////////////

    static String SAMPLE_PODS_ERROR = "error: The sandbox is not in sync with the Podfile.lock. Run 'pod install' or update your CocoaPods installation."

    static String SAMPLE_COMPILE_ERROR = '''
                    /Users/musalj/code/OSS/SampleApp/SampleTest.m:12:59: error: expected identifier
                                    [[thread.lastMessage should] equal:thread.];
                                                                              ^
                    '''.stripIndent().trim()

    static String SAMPLE_FILE_MISSING_ERROR = '''
    ...
    static String SAMPLE_CODESIGN_ERROR = '''
    ...
    static String SAMPLE_CODESIGN_ERROR_NO_SPACES = '''
                    CodeSign error: code signing is required for product type 'Application' in SDK 'iOS 7.0'
                    '''.stripIndent().trim()

    static String SAMPLE_REQUIRES_PROVISION = '''
    ...
    static String SAMPLE_NO_CERTIFICATE = '''
    ...
    static String SAMPLE_FATAL_COMPILE_ERROR = '''
    ...
    static String SAMPLE_FATAL_COMPILE_PCH_ERROR = '''
    ...
    static String SAMPLE_FATAL_HEADER_ERROR = '''
    ...
    static String SAMPLE_UNDEFINED_SYMBOLS = '''
    ...
    static String SAMPLE_DUPLICATE_SYMBOLS = '''
    ...
    static String SAMPLE_BITCODE_LD = '''
    ...
    static String SAMPLE_LD_SYMBOLS_ERROR = 'ld: symbol(s) not found for architecture x86_64'
    static String SAMPLE_LD_LIBRARY_ERROR = 'ld: library not found for -lPods-Yammer'

    static String SAMPLE_CLANG_ERROR = 'clang: error: linker command failed with exit code 1 (use -v to see invocation)'

    static String SAMPLE_COMPILE_ERROR_WITH_TILDES = '''
    ...
    static String SAMPLE_PROFILE_DOESNT_SUPPORT_CAPABILITY_ERROR = '''
                    Provisioning profile "Profile Name" doesn't support the Push Notifications capability.
                    '''.stripIndent().trim()

    static String SAMPLE_PROFILE_DOESNT_INCLUDE_ENTITLEMENT_ERROR = '''
                    Provisioning profile "Profile Name" doesn't include the aps-environment entitlement.
                    '''.stripIndent().trim()

    static String SAMPLE_CODE_SIGNING_IS_REQUIRED_ERROR = '''
                    Code signing is required for product type 'Application' in SDK 'iOS 10.0'
                    '''.stripIndent().trim()

    static String SAMPLE_NO_PROFILE_MATCHING_ERROR = """
    ...
    static String SAMPLE_SWIFT_UNAVAILABLE = "Swift is unavailable on iOS earlier than 7.0; please set IPHONEOS_DEPLOYMENT_TARGET to 7.0 or later (currently it is '6.0')."

    static String SAMPLE_USE_LEGACY_SWIFT = "“Use Legacy Swift Language Version” (SWIFT_VERSION) is required to be configured correctly for targets which use Swift. Use the [Edit > Convert > To Current Swift Syntax…] menu to choose a Swift version or use the Build Settings editor to configure the build setting directly."

    static String SAMPLE_MODULE_INCLUDES_ERROR = "<module-includes>:1:1: error: umbrella header for module 'ModuleName' does not include header 'Header.h'"

    ////////////////////////////////////////////////////////////////////////////////////
    // WARNINGS
    ////////////////////////////////////////////////////////////////////////////////////

    static String SAMPLE_FORMAT_WARNING = '''
    ...
    static String SAMPLE_WILL_NOT_BE_CODE_SIGNED = "FrameworkName will not be code signed because its settings don't specify a development team."
    static String SAMPLE_FORMAT_OTHER_UNRECOGNIZED_STRING = "This is a string that won't be matched by any other regex."
